...
class User(Base):
    ...
    # doctor_id = Column(Integer, ForeignKey("doctor.id"), default=None)
    # doctor_name = Column(VARCHAR(30), ForeignKey("doctor.name"), default=None)
    create_time = Column(DateTime(), nullable=False, default=datetime.now(), onupdate=False)
...
class Role(Base):
    ...
    permission_parent_id = Column(Integer, nullable=True, comment="父角色id")
...
class Permission(Base):
    ...
    permission_id = Column(Integer, nullable=False, primary_key=True, autoincrement=True)
    permission_name = Column(VARCHAR(50), nullable=False, primary_key=True, comment="权限名")
...
class UserRole(Base):
    ...
    ur_id = Column(Integer, nullable=False, primary_key=True, autoincrement=True)
...
class RolePermission(Base):
    ...
    rp_id = Column(Integer, nullable=False, primary_key=True, autoincrement=True)
    role_id = Column(Integer, ForeignKey("t_role.role_id"), nullable=False)
    role_name = Column(VARCHAR(25), ForeignKey("t_role.role_name"), nullable=False, comment="角色名")
...
class Diagnose:
    ...
    diagnose_time = Column(DateTime(), default=datetime.now(), onupdate=False, nullable=False)
...
class Feedback:
    ...
    feedback_time = Column(DateTime(), default=datetime.now(), onupdate=False, nullable=False)
...
class Avatar:
    ...
    avatar_upload_time = Column(DateTime(), default=datetime.now(), onupdate=False, nullable=False)
...
class LoginLog:
    ...
    login_time = Column(DateTime(), default=datetime.now(), onupdate=False, nullable=False, comment="登录时间")
...
class UploadLog:
    ...
    upload_time = Column(DateTime(), default=datetime.now(), onupdate=False, nullable=False)
